...
leftRotate(x): rotar a la izquierda el nodo x. X
rightRotate(x): rotar a la derecha el nodo x. X
Insert(x): Insertar x en el árbol (implementar insertFix) X
Remove(x): Eliminar x del árbol (implementar removeFix) X
*/
